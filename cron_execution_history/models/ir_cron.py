...
class IrCron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id):
        ...
        18.0/19.0 signature: (cron_name, server_action_id), on the cron
    ...
    # method_direct_trigger is NOT overridden here: from 19.0 the "Run Manually"
    # button goes through _process_job -> _run_job like the scheduler does, so
    # manual runs are already recorded above. Wrapping it would log them twice.
